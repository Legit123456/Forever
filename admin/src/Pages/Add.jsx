    ...
    >
      ...
      <div className="w-full">
        ...
        <input
          ...
          value={name}
          className="w-full max-w-125 px-3 py-2 mb-2"
          type="text"
      ...
      <div className="flex flex-col sm:flex-row gap-2 w-full sm:gap-8">
        ...
        <div>
          <p className="mb-1">Product Prince</p>
          <input
            onChange={(e) => setPrice(e.target.value)}
            value={price}
            className="w-full px-3 py-2 sm:w-30 mb-2"
            type="number"
            placeholder="25"
            required
          />
      ...
      <button
        type="submit"
        disabled={loading}
        className={`w-28 py-3 mt-4 text-white rounded
